export const BOARD_WIDTH_PCT = 100;
export const BOARD_HEIGHT_PCT = 100;
export const LANE_COUNT = 4;

// Colors
export const COLOR_WHITE = '#FFFFFF';
export const COLOR_BLACK = '#000000';
export const COLOR_RED = '#EF4444'; // Tailwind Red 500
export const COLOR_NEON_BLUE = '#06B6D4'; // Cyan
export const COLOR_NEON_PURPLE = '#D946EF'; // Fuchsia
